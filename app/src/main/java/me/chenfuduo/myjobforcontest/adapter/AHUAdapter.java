 ...
 */
public class AHUAdapter extends DefaultAdapter<JobInfo>  {

    private ListView listView;

    public AHUAdapter(List<JobInfo> jobInfos, ListView listView) {
    ...
    protected List<JobInfo> onload() {
        ...
        List<JobInfo> jobInfos = ahuProtocol.load(48, 30);
