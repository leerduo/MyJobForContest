 ...
 */
public class USTCAdapter extends DefaultAdapter<JobInfo> {

    private ListView listView;

    public USTCAdapter(List<JobInfo> jobInfos, ListView listView) {
    ...
    protected List<JobInfo> onload() {
        ...
        List<JobInfo> jobInfos = ustcProtocol.load(47, 30);
        int size = jobInfos.size();
        Log.e("MyTest", "onload " + size);
